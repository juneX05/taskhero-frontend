...
<template>
  <Layout>
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="flex items-center space-x-2">
          ...
          <div class="flex">
            ...
            <router-link
                ...
                class="btn h-8 space-x-2 rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"
            >
              <i class="fa fa-plus-circle h-4.5 w-4.5"></i>
              <span> Add User </span>
            </router-link>
          </div>
        </div>
      ...
      >
        <div v-for="(user, index) in usersStore.users" :key="index"
             class="card grow items-center p-4 sm:p-5">
          ...
          <router-link :to="{ name: 'users-view', params: { id: user.urid } } "

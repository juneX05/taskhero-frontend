...
import {usePermissionsStore} from "./__permissionsStore.js";
...
const page = {
  ...
  button_title: 'Create Permission',
}

const init = async () => {
  loading.value = true
  await permissionsStore.getAllData()
  records.value = permissionsStore.records;
  loading.value = false
}
